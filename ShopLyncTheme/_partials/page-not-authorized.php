...
<div class="container container-fluid">
	<div class="row">
		...
		<h1 class="display-1 text-center">Not Logged In</h1>
			<div class="card rounded-15 text-center pt-2 px-1 my-2" id="login-form">
			<i class="material-icons font-10rem text-primary">cancel</i>
			  <div class="card-body">
				<h6 class="text-primary"><i class="material-icons">block</i> This link is no longer valid. Please login and try again.</h6>
